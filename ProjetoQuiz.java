...
public class ProjetoQuiz {
  ...
  //variaveis usadas para armazenar a pontuação total de cada teste
	...
	public static void main(String[] args) {
		...
		System.out.println("\n--------------------------------------------------------------------------------------------\n");
		System.out.println("****QUIZ EDUCATIVO****");
  ...
  //intruções de como jogar e regras do jogo
    ...
    System.out.println("2° Logo em seguida aparecera o menu dos temas, assim basta você escolher qual tema você deseja testar os seus conhecimentos e seleciona-lo.");
    
    System.out.println("\nCada teste é composto por 10 questões, a pontução máxima em cada teste será de 100 pontos. Abaixo você encontrada as regras para a contabilização das pontuações em cada teste.");
    ...
    System.out.println("* Se acertar na segunda tentativa soma +5 pontos.");
    System.out.println("\nVocê pode verificar quais foram as suas ultimas pontuações nos testes, selecionando a opção (5- Ultimas pontuações) no menu principal.");
		System.out.println("\n--------------------------------------------------------------------------------------------\n");
		tecleParaVoltar();
	}
  ...
  // Função que executa cada um dos testes.
    ...
    System.out.println("\n--------------------------------------------------------------------------------------------\n");
		...
		System.out.println("B) mede mais que 0º e menos que 90º mede mais que 0º e menos que 90º");
